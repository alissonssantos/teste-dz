...
<![endif]-->
    ...
    <!--[if lt IE 9]><script src="<?php echo e(URL::asset('resources/js/plugin/ie8-responsive-file-warning.js')); ?>"></script><![endif]-->

    <script src="<?php echo e(URL::asset('resources/js/plugin/ie-emulation-modes-warning.js')); ?>"></script>

    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="<?php echo e(URL::asset('resources/js/plugin/ie10-viewport-bug-workaround.js')); ?>"></script>

    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
      <script src="<?php echo e(URL::asset('resources/js/plugin/html5shiv.js')); ?>"></script>
      <script src="<?php echo e(URL::asset('resources/js/plugin/respond.js')); ?>"></script>
    <![endif]-->
    ...
    <body>    
     ...
     <section class="slider">
         <div class="item-slider" style="background-image: url('<?php echo e('resources/img/foto-slider.jpg'); ?>')">
